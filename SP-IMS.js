  ...
  methods: {
    ...
    async getDate(pageNum) {
      const { data: res } = await axios({
        method: "get",
        url: "http://43.143.162.177:8077/get/programList",
        params: {
          pageNum,
        },
        headers: {
    ...
    async addData(addForm) {
      const { data: res } = await axios({
        method: "post",
        url: "http://43.143.162.177:8077/add/program",
        data: {
    ...
    async search(searchForm) {
      const { data: res } = await axios({
        method: "get",
        url: "http://43.143.162.177:8077/get/search",
        params: {
    ...
    async editData(editForm) {
      const { data: res } = await axios({
        method: "post",
        url: "http://43.143.162.177:8077/post/editData",
        data: {
    ...
    async deleteData(index) {
      const { data: res } = await axios({
        method: "post",
        url: "http://43.143.162.177:8077/delete/program",
        data: {
          id:index
        },
        headers: {
